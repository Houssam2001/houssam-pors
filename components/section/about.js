...
export default function About() {
  let umur = sAge("Apr 08 2001");
  let [gh, setGh] = useState('Fetching...');
  useEffect(() => {
    (async() => {
      try {
        const res = await fetch("https://api.github.com/users/Houssam2001");
          ...
          <section id="about" className="text-black py-20">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="ml-10 mr-10 pt-10">
                ...
                ></div>
                <p className="mt-2">
                  {`I live in Casablanca, Morocco. My full name is Houssam Machmech
                  , just call me Houssam. I'm ${umur} years old. A Software
                  Engineering student, I have known Programming since 2017 and
                ...
                <p className="mt-5">
                  ...
                  learning New Things about Back End in Python and OpenCV now. I don&apos;t
                  know, I&apos;m a person who likes to learn new things .
                </p>
                <p className="mt-5">
                  ...
                  freelance projects ,templates or even just a package to make things easier..
                </p>
